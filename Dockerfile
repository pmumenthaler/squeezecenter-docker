...
RUN yum install -y perl-CGI.noarch perl-Digest-MD5.x86_64 container-selinux && yum clean all -y
RUN ln -s /usr/lib/perl5/vendor_perl/Slim /usr/lib64/perl5/Slim && setsebool -P virt_use_nfs 1
